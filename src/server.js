...
export function llmsTxt(router) {
  ...
  const lines = [
    ...
    '',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/forms/FORM/routing \\',
    ...
    '    curl -s http://127.0.0.1:8080/e/EVENT/forms/FORM',
    '',
    ...
    '',
    '    curl -s http://127.0.0.1:8080/api/events/EVENT/agenda      # see what has no slot',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/agenda/autoschedule',
    '    # or place one by hand:',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/submissions/SESS-3/schedule \\',
    ...
    '',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/submissions/SESS-3/content \\',
    '         --data "content_status=approved"',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/agenda/publish',
    '',
    ...
    '',
    '    curl -s "http://127.0.0.1:8080/e/EVENT/mail?audience=outstanding-tasks"',
    '    curl -s -X POST http://127.0.0.1:8080/e/EVENT/mail \\',
    '         --data-urlencode "audience=outstanding-tasks" \\',
    '         --data-urlencode "subject=..." --data-urlencode "body=..."',
    '',
    '### Collect what speakers have uploaded',
    '',
    '    curl -s -o files.zip "http://127.0.0.1:8080/e/EVENT/files.zip?group=speaker&task=upload-slides"',
    '',
